...
```bash
npm install capacitor7-google-maps
npx cap sync
```
...
```typescript
import { GoogleMap } from 'capacitor7-google-maps';
...
| **`rotation`**   | <code>number</code>                                          | The angle by which to rotate the marker, expressed clockwise in degrees                                                                                                                   | <code>0</code>     |       |
